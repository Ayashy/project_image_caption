...
data_name = 'flickr'
data_folder = os.path.join('processed_data', data_name)

# Model parameters
embedding_len = 512  # dimension of word embeddings
attention_len = 512  # dimension of attention linear layers
lstm_len = 512  # dimension of decoder RNN
dropout = 0.5
...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        FlickrDataset(data_folder, 'DEV'),
        batch_size=5, )
    val_loader = torch.utils.data.DataLoader(
        FlickrDataset(data_folder, 'EVAL'),
        batch_size=5, )
    # Epochs
    for epoch in range(start_epoch, epochs):
        ...
        # Save checkpoint
        save_checkpoint(data_name, epoch, epochs_since_improvement, decoder,
